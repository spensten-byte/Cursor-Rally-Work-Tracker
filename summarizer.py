...
PROMPT_NAMES = ("extract", "rollup", "exec_rollup", "leadership_chat")
...
class MeetingSummarizer:
    ...
    def chat_with_history(
        ...
        """Multi-turn chat. `messages` is a list of {role, content} dicts in order."""
        if self.settings.mock_llm:
            raise RuntimeError("mock_llm enabled — chat is disabled in mock mode")
